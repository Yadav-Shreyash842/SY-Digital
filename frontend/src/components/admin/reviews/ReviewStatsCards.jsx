...
import {
  MessageSquareText, CheckCircle2, Clock, XCircle, Star, FileText,
} from 'lucide-react'
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
      {cards.map((card, i) => {
        ...
        const display = card.suffix ? `${animateValue(val)}${card.suffix}` : animateValue(val)
