...
export function SkeletonCard({ theme = 'dark' }) {
  return (
    <div className={cn('rounded-[20px] border p-6', theme === 'dark' ? 'border-white/8 bg-card-bg' : 'border-gray-200 bg-white')}>
...
export function SkeletonTable({ rows = 5, theme = 'light' }) {
  return (
    <div className={cn('rounded-[20px] border overflow-hidden', theme === 'dark' ? 'border-white/8' : 'border-gray-200 bg-white')}>
