  ...
  return (
    <SectionContainer id="statistics">
      <div className="relative overflow-hidden rounded-[24px] border border-white/8 bg-gradient-to-br from-section-bg to-secondary-bg p-8 sm:p-12 lg:p-16">
        <div className="absolute top-0 right-0 h-64 w-64 rounded-full bg-primary-purple/10 blur-[100px]" />
        ...
        >
          ...
          <h2 className="text-[28px] font-bold sm:text-[32px] lg:text-[40px]">
          ...
          {stats.map((stat, i) => (
            ...
            >
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/5">
                <stat.icon strokeWidth={1.75} className="h-7 w-7 text-primary-purple" />
              </div>
